...
CREATE TABLE `purchases` (
  ...
  `billing_same_as_shipping` INT(1) NOT NULL DEFAULT 0,
...
INSERT INTO `purchases` (`id`, `creator_id`, `number`, `currency`, `billing_address_id`, `billing_same_as_shipping`, `monetary`, `is_frozen`, `is_deleted`)
VALUES
